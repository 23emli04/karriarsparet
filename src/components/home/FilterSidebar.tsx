  ...
  return (
    <div>
      <input
        ...
        className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 bg-slate-50 placeholder:text-slate-400 focus:ring-2 focus:ring-slate-300 focus:outline-none mb-3"
      />
      <ProviderFilter
